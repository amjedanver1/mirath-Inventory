package com.example.mirathinventory.services.impl;

import com.example.mirathinventory.dto.tenent.ShopDetails;
import com.example.mirathinventory.services.ShopService;
...
public class ShopServiceImpl implements ShopService {
    private static Logger logger = LogManager.getLogger(ShopServiceImpl.class);
    @Override
